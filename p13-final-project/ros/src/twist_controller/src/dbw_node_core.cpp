...
void DBWNode::initForROS()
{
    ...
    sub_enable_ = nh_.subscribe("/vehicle/dbw_enabled", 1, &DBWNode::cbFromRecvEnable, this);
    ...
    sub_fuel_report_ = nh_.subscribe("/vehicle/fuel_level_report", 2, &DBWNode::cbFromFuelLevelReport, this);
...
void DBWNode::cbFromFuelLevelReport(const dbw_mkz_msgs::FuelLevelReport::ConstPtr& msg)
{
